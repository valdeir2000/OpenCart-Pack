<?php
	...
	if (isset($_POST) && !empty($_POST)):
		...
		if (!empty($user->rows)):
			...
			$mensagem = 'Houve uma atualização na loja <a href="' . HTTP_SERVER . '">' . $config_name . '</a>';
			...
			$mail->setSubject(html_entity_decode('Akatus Atualizado', ENT_QUOTES, 'UTF-8'));
    ...
    <body>
        <div class="container" style="height:100% !important">
			<div id="wrapper" style="margin:0 auto;height:99%;">
				...
				<h2 class="subTitle" style="margin:20px auto">Digite seu login e senha para poder atualizar o módulo</h2>	
				<?php else: ?>
				<h2 class="subTitle" style="margin:20px auto">Módulo atualizado com sucesso</h2>	
				<?php endif ?>
