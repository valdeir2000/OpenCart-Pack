...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            /* This most probably won't work in all email clients. Don't include <code _tmplitem="344" > blocks in email. */
            code {
              white-space: normal;
                        ...
                        <tr>
                            <td id="header" class="w640" width="640" align="center" bgcolor="#000000">
                                <div align="center" style="text-align: center">
                                    <a href="<?php echo $url ?>">
                                    <img src="<?php echo $logo ?>" id="customHeaderImage" label="Header Image" editable="true" width="268" class="w640" border="0" align="top" style="display: inline">
                                    </a>
                                </div>
                            </td>
                        </tr>
                                                            ...
                                                            <tbody><tr>
                                                                <td class="w580" width="580">
                                                                    ...
                                                                    <div align="left" class="article-content">
                                                                        <multiline label="Description"><?php echo $message ?></multiline>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <span class="hide">
                                                <p id="permission-reminder" align="left" class="footer-content-left">
                                                    <small>Sistema desenvolvidor por: Valdeir Santana</small>
                                                </p>
                                            </span>
                                        </tr>
