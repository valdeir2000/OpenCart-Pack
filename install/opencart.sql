...
--
INSERT INTO `oc_language` SET `name` = 'Português (BR)', `code` = 'pt-br', `locale` = 'pt_BR.UTF-8, pt_BR, UTF-8', `directory` = 'portuguese-br', `image` = 'br.png', `sort_order` = 1, `status` = 1;
