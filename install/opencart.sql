...
INSERT INTO `oc_currency` SET `title` = 'Real', `code` = 'BRL', `symbol_left` = 'R$', `symbol_right` = '', `decimal_place` = '2', `value` = 1.00000000, `status` = 1, `date_modified` = NOW();
...
--
INSERT INTO `oc_language` SET `language_id` = 1, `name` = 'Português (BR)', `code` = 'pt-br', `locale` = 'pt_BR.UTF-8, pt_BR, UTF-8', `directory` = 'portuguese-br', `image` = 'br.png', `sort_order` = 1, `status` = 1;
...
ALTER TABLE `oc_product` ADD `free_shipping` INT NOT NULL DEFAULT '0' AFTER `manufacturer_id`;
...
(186, 0, 'config', 'config_country_id', '30', 0),
(187, 0, 'config', 'config_zone_id', '3563', 0),
(188, 0, 'config', 'config_language', 'pt-br', 0),
(189, 0, 'config', 'config_admin_language', 'pt-br', 0),
(190, 0, 'config', 'config_currency', 'BRL', 0),
...
(301, 0, 'free', 'free_total', '0', 0),
(302, 0, 'free', 'free_geo_zone_id', '0', 0),
(303, 0, 'free', 'free_status', '1', 0),
(304, 0, 'free', 'free_sort_order', '', 0);
...
(1, 'account/register', 'cadastrar'),
(2, 'account/login', 'logar'),
(3, 'account/success', 'registrado'),
(4, 'account/account', 'minha-conta'),
(5, 'account/edit', 'informacoes-pessoais'),
(6, 'account/password', 'modificar-senha'),
(7, 'account/address', 'meus-enderecos'),
(8, 'account/address/edit', 'editar-endereco'),
(9, 'account/wishlist', 'lista-de-desejos'),
(10, 'account/order', 'meus-pedidos'),
(11, 'account/download', 'meus-downloads'),
(12, 'account/recurring', 'minhas-assinaturas'),
(13, 'account/reward', 'meus-pontos'),
(14, 'account/return', 'solicitar-devolucao'),
(15, 'account/transaction', 'minhas-transacoes'),
(16, 'account/newsletter', 'informativos'),
(17, 'account/logout', 'sair'),
(18, 'common/home', ''),
(19, 'checkout/cart', 'carrinho'),
(20, 'checkout/checkout', 'finalizar-pedido'),
(21, 'checkout/success', 'pedido-cadastrado'),
(22, 'account/order/info', 'pedido'),
(23, 'information/contact', 'contato'),
(24, 'information/sitemap', 'sitemap'),
(25, 'product/manufacturer', 'fabricantes'),
(26, 'account/voucher', 'vale-presente'),
(27, 'affiliate/login', 'afiliado/logar'),
(28, 'affiliate/success', 'afiliado/registrado'),
(29, 'affiliate/account', 'afiliado/conta'),
(30, 'product/special', 'promocoes'),
...
(1, 'MoiP Checkout Transparente', 'valdeir_moip', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>MoiP Checkout Transparente</name>\r\n  <version>1.0</version>\r\n  <author>Valdeir Psr</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  <code>valdeir_moip</code>\r\n  <file path="catalog/controller/checkout/checkout.php">\r\n    <operation>\r\n      <search><![CDATA[$this->load->language(''checkout/checkout'');]]></search>\r\n      <add position="after"><![CDATA[\r\n        //Verifica se está em modo de teste\r\n        if (!$this->config->get(''moip_modo_teste'')) {\r\n          $this->document->addScript(''https://www.moip.com.br/transparente/MoipWidget-v2.js'');\r\n        } else {\r\n          $this->document->addScript(''https://desenvolvedor.moip.com.br/sandbox/transparente/MoipWidget-v2.js'');\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-27 18:36:59'),
(2, 'PagSeguro Checkout Transparente', 'valdeir_pagseguro', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>PagSeguro Checkout Transparente</name>\r\n  <code>19676</code>\r\n  <version>1.0</version>\r\n  <author>Valdeir Psr</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  <link>valdeir_pagseguro</link>\r\n  <file path="catalog/controller/checkout/checkout.php">\r\n    <operation>\r\n      <search><![CDATA[$this->load->language(''checkout/checkout'');]]></search>\r\n      <add position="after"><![CDATA[\r\n        //Verifica se está em modo de teste\r\n        if (!$this->config->get(''pagseguro_modo_teste'')) {\r\n          $this->document->addScript(''https://stc.pagseguro.uol.com.br/pagseguro/api/v2/checkout/pagseguro.directpayment.js'');\r\n        } else {\r\n          $this->document->addScript(''https://stc.sandbox.pagseguro.uol.com.br/pagseguro/api/v2/checkout/pagseguro.directpayment.js'');\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-27 18:37:02'),
(3, 'Boleto Caixa - Segunda Via', 'boleto-caixa-segunda-via', 'Ibrahim Brumate', '1.0', 'http://www.opencartbrasil.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n    <name>Boleto Caixa - Segunda Via</name>\r\n  <code>boleto-caixa-segunda-via</code>\r\n <version>1.0</version>\r\n  <author>Ibrahim Brumate</author>\r\n  <link>http://www.opencartbrasil.com.br</link>\r\n\r\n <file path="catalog/model/account/order.php">\r\n   <operation>\r\n         <search><![CDATA[''payment_method''          => $order_query->row[''payment_method''],]]></search>\r\n          <add position="after">\r\n            <![CDATA[\r\n               ''payment_code''          => $order_query->row[''payment_code''],\r\n             ]]>\r\n         </add>\r\n        </operation>\r\n   </file>\r\n\r\n   <file path="catalog/controller/account/order.php">\r\n   <operation>\r\n         <search><![CDATA[$order_info = $this->model_account_order->getOrder($order_id);]]></search>\r\n           <add position="after">\r\n            <![CDATA[\r\n               $this->load->library(''encryption'');\r\n               $encryption = new Encryption($this->config->get(''config_encryption''));\r\n              $data[''order_id_encryption''] = $encryption->encrypt($order_id);\r\n             ]]>\r\n           </add>\r\n    </operation>\r\n    <operation>\r\n         <search><![CDATA[$data[''payment_method''] = $order_info[''payment_method''];]]></search>\r\n           <add position="after">\r\n            <![CDATA[\r\n               $data[''payment_code''] = $order_info[''payment_code''];\r\n            ]]>\r\n           </add>\r\n    </operation>\r\n  </file>\r\n\r\n <file path="catalog/view/theme/*/template/account/order_info.tpl">\r\n    <operation>\r\n         <search><![CDATA[<div class="buttons clearfix">]]></search>\r\n         <add position="before" offset="1">\r\n            <![CDATA[\r\n             <?php if (($payment_code == "boleto_cef_sigcb") && ($histories[(sizeof($histories) - 1)][''status''] == "Aguardando Pagamento")) { ?>\r\n             <h3>Finalizar Pagamento</h3>\r\n              <table class="table table-bordered table-hover">\r\n                <thead>\r\n                 <tr>\r\n                    <td class="text-left">M&eacute;todo de Pagamento</td>\r\n                   <td class="text-left">A&ccedil;&atilde;o</td>\r\n                 </tr>\r\n               </thead>\r\n                <tbody>\r\n                 <tr>\r\n                    <td class="text-left"><?php echo $payment_method; ?></td>\r\n                   <td class="text-left"><a href="index.php?route=payment/boleto_cef_sigcb/callback&order_id=<?php echo $order_id_encryption; ?>" target="_blank">Gerar 2ª Via do Boleto</a></td>\r\n                  </tr>\r\n               </tbody>\r\n              </table>\r\n              <?php } ?>\r\n            ]]>\r\n         </add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-27 18:36:45'),
(4, 'Boleto Itaú - Segunda Via', 'boleto-itau-segunda-via', 'Ibrahim Brumate', '1.0', 'http://www.opencartbrasil.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n    <name>Boleto Itaú - Segunda Via</name>\r\n <code>boleto-itau-segunda-via</code>\r\n  <version>1.0</version>\r\n  <author>Ibrahim Brumate</author>\r\n  <link>http://www.opencartbrasil.com.br</link>\r\n\r\n <file path="catalog/model/account/order.php">\r\n   <operation>\r\n         <search><![CDATA[''payment_method''          => $order_query->row[''payment_method''],]]></search>\r\n          <add position="after">\r\n            <![CDATA[\r\n               ''payment_code''          => $order_query->row[''payment_code''],\r\n             ]]>\r\n         </add>\r\n        </operation>\r\n   </file>\r\n\r\n   <file path="catalog/controller/account/order.php">\r\n   <operation>\r\n         <search><![CDATA[$order_info = $this->model_account_order->getOrder($order_id);]]></search>\r\n           <add position="after">\r\n            <![CDATA[\r\n               $this->load->library(''encryption'');\r\n               $encryption = new Encryption($this->config->get(''config_encryption''));\r\n              $data[''order_id_encryption''] = $encryption->encrypt($order_id);\r\n             ]]>\r\n           </add>\r\n    </operation>\r\n    <operation>\r\n         <search><![CDATA[$data[''payment_method''] = $order_info[''payment_method''];]]></search>\r\n           <add position="after">\r\n            <![CDATA[\r\n               $data[''payment_code''] = $order_info[''payment_code''];\r\n            ]]>\r\n           </add>\r\n    </operation>\r\n  </file>\r\n\r\n <file path="catalog/view/theme/*/template/account/order_info.tpl">\r\n    <operation>\r\n         <search><![CDATA[<div class="buttons clearfix">]]></search>\r\n         <add position="before" offset="1">\r\n            <![CDATA[\r\n             <?php if (($payment_code == "boleto_itau") && ($histories[(sizeof($histories) - 1)][''status''] == "Aguardando Pagamento")) { ?>\r\n              <h3>Finalizar Pagamento</h3>\r\n              <table class="table table-bordered table-hover">\r\n                <thead>\r\n                 <tr>\r\n                    <td class="text-left">M&eacute;todo de Pagamento</td>\r\n                   <td class="text-left">A&ccedil;&atilde;o</td>\r\n                 </tr>\r\n               </thead>\r\n                <tbody>\r\n                 <tr>\r\n                    <td class="text-left"><?php echo $payment_method; ?></td>\r\n                   <td class="text-left"><a href="index.php?route=payment/boleto_itau/callback&order_id=<?php echo $order_id_encryption; ?>" target="_blank">Gerar 2ª Via do Boleto</a></td>\r\n                 </tr>\r\n               </tbody>\r\n              </table>\r\n              <?php } ?>\r\n            ]]>\r\n         </add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-27 18:36:48'),
(5, 'CodeManager by iSenseLabs', 'isenselabs_codemanager', 'iSenseLabs', '1.1', 'http://isenselabs.com', '<modification>\r\n  <name>CodeManager by iSenseLabs</name>\r\n  <version>1.1</version>\r\n  <link>http://isenselabs.com</link>\r\n  <author>iSenseLabs</author>\r\n <code>isenselabs_codemanager</code>\r\n\r\n <file path="admin/view/template/common/menu.tpl">\r\n   <operation>\r\n     <search><![CDATA[<li><a href="<?php echo $backup; ?>"><?php echo $text_backup; ?></a></li>]]></search>\r\n      <add position="after"><![CDATA[\r\n       <li><a href="index.php?route=module/codemanager&token=<?php echo $_GET[''token'']; ?>">Code Manager</a></li>\r\n      ]]></add>\r\n   </operation>\r\n  </file> \r\n</modification>', 0, '2015-04-27 18:36:53'),
(6, 'Máscaras + Busca CEP + Validador', 'valdeir_pack_validacao', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="UTF-8"?>\r\n<modification>\r\n  <name>Máscaras + Busca CEP + Validador</name>\r\n  <code>valdeir_pack_validacao</code> \r\n  <version>1.0</version>\r\n  <author>Valdeir Psr</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  \r\n  <!-- Add Javascript -->\r\n  <file path="catalog/controller/account/address.php,catalog/controller/account/register.php,catalog/controller/account/edit.php,catalog/controller/checkout/checkout.php">\r\n    <operation>\r\n      <search><![CDATA[$this->document->addScript(''catalog/view/javascript/jquery/datetimepicker/moment.js'');]]></search>\r\n      <add position="after"><![CDATA[$this->document->addScript(''catalog/view/javascript/jquery/jquery.maskedinput.js'');]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Add Javascript -->\r\n  <file path="catalog/controller/checkout/cart.php,catalog/controller/checkout/register.php">\r\n    <operation>\r\n      <search><![CDATA[public function index() {]]></search>\r\n      <add position="after"><![CDATA[$this->document->addScript(''catalog/view/javascript/jquery/jquery.maskedinput.js'');]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Add Javascript -->\r\n  <file path="catalog/controller/account/register.php">\r\n    <operation>\r\n      <search><![CDATA[return !$this->error;]]></search>\r\n      <add position="before"><![CDATA[\r\n        if (!$this->valida_cpf_cnpj()) {\r\n          $this->error[''custom_field''][4] = ''CPF/CNPJ Incorreto.'';\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search><![CDATA[public function validate() {]]></search>\r\n      <add position="before"><![CDATA[\r\n        private function valida_cpf_cnpj() {\r\n          $input = preg_replace(''/[^0-9]/'', '''', $this->request->post[''custom_field''][''account''][4]);\r\n\r\n          if (strlen($input) == 11) {\r\n            // Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            if (strlen($c) != 11 || preg_match("/^{$c[0]}{11}$/", $c)) {\r\n                return false;\r\n            }\r\n            for ($s = 10, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[9] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($s = 11, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[10] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n\r\n            return true;\r\n          } elseif (strlen($input) == 14) {\r\n\r\n            //Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            $b = array(6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2);\r\n            if (strlen($c) != 14) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i < 12; $n += $c[$i] * $b[++$i]);\r\n            if ($c[12] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i <= 12; $n += $c[$i] * $b[$i++]);\r\n            if ($c[13] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            return true;\r\n          }\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Acount/edit -->\r\n  <file path="catalog/controller/account/edit.php">\r\n    <operation>\r\n      <search><![CDATA[return !$this->error;]]></search>\r\n      <add position="before"><![CDATA[\r\n        if (!$this->valida_cpf_cnpj()) {\r\n          $this->error[''custom_field''][4] = ''CPF/CNPJ Incorreto.'';\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search><![CDATA[protected function validate() {]]></search>\r\n      <add position="before"><![CDATA[\r\n        private function valida_cpf_cnpj() {\r\n          $input = preg_replace(''/[^0-9]/'', '''', $this->request->post[''custom_field''][4]);\r\n\r\n          if (strlen($input) == 11) {\r\n            // Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            if (strlen($c) != 11 || preg_match("/^{$c[0]}{11}$/", $c)) {\r\n                return false;\r\n            }\r\n            for ($s = 10, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[9] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($s = 11, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[10] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n\r\n            return true;\r\n          } elseif (strlen($input) == 14) {\r\n\r\n            //Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            $b = array(6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2);\r\n            if (strlen($c) != 14) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i < 12; $n += $c[$i] * $b[++$i]);\r\n            if ($c[12] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i <= 12; $n += $c[$i] * $b[$i++]);\r\n            if ($c[13] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            return true;\r\n          }\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Altera a posição input -->\r\n  <file path="catalog/view/theme/*/template/account/register.tpl,catalog/view/theme/*/template/account/address_form.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            var inputPostcode = $(''input[name="postcode"]'').parent().parent().detach();\r\n            $(''input[name="address_1"]'').parent().parent().before(inputPostcode);\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- checkout/checkout #payment-address -->\r\n  <file path="catalog/view/theme/*/template/checkout/payment_address.tpl">\r\n    <operation>\r\n      <search><![CDATA[$(''.datetime'').datetimepicker({]]></search>\r\n      <add position="before"><![CDATA[\r\n            var inputPostcode = $(''#payment-new input[name="postcode"]'').parent().parent().detach();\r\n            $(''#payment-new input[name="address_1"]'').parent().parent().before(inputPostcode);\r\n\r\n            $(''#payment-new input[name="postcode"]'').mask(''99999-999'');\r\n\r\n            var zones = {AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466};\r\n            \r\n            $(''#payment-new input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''#payment-new input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''#payment-new input[name="address_2"]'').val(data.bairro);\r\n                    $(''#payment-new input[name="city"]'').val(data.cidade);\r\n                    $(''#payment-new select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''#payment-new select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                  \r\n                  $(''#payment-new #input-payment-custom-field1'').focus();\r\n                })\r\n              }\r\n            })\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- checkout/register -->\r\n  <file path="catalog/view/theme/*/template/checkout/register.tpl">\r\n    <operation>\r\n      <search index="0"><![CDATA[$(''#collapse-payment-address select[name=\\''country_id\\'']'').trigger(''change'');]]></search>\r\n      <add position="before"><![CDATA[\r\n\r\n            var inputPostcode = $(''input[name="postcode"]'').parent().detach();\r\n            $(''input[name="address_1"]'').parent().before(inputPostcode);\r\n     \r\n      var inputNumero = $(''input[name="custom_field[address][5]"]'').parent().detach();\r\n            $(''input[name="address_1"]'').parent().after(inputNumero);\r\n\r\n            $(''input[name="postcode"]'').mask(''99999-999'');\r\n            $(''input[name="telephone"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="fax"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="custom_field[account][4]"]'').mask(''999.999.999-99'');\r\n\r\n            $(''select[name="custom_field[account][3]"]'').change(function(){\r\n              if ($(''select[name="custom_field[account][3]"]'').val() == ''4'') {\r\n                $(''input[name="custom_field[account][4]"]'').mask(''99.999.999/9999-99'');\r\n              } else {\r\n        $(''input[name="custom_field[account][4]"]'').mask(''999.999.999-99'');\r\n       }\r\n            })\r\n\r\n            var zones = {\r\n              AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466\r\n            };\r\n            \r\n            $(''input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''input[name="address_2"]'').val(data.bairro);\r\n                    $(''input[name="city"]'').val(data.cidade);\r\n                    $(''select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                  \r\n                   $(''input[name="custom_field[address][5]"]'').focus();\r\n                })\r\n              }\r\n            })\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n  \r\n\r\n  <!-- checkout/checkout #shipping-address -->\r\n  <file path="catalog/view/theme/*/template/checkout/shipping_address.tpl">\r\n    <operation>\r\n      <search><![CDATA[$(''.datetime'').datetimepicker({]]></search>\r\n      <add position="before"><![CDATA[\r\n            var inputPostcode = $(''#shipping-new input[name="postcode"]'').parent().parent().detach();\r\n            $(''#shipping-new input[name="address_1"]'').parent().parent().before(inputPostcode);\r\n\r\n            $(''#shipping-new input[name="postcode"]'').mask(''99999-999'');\r\n\r\n            var zones = {\r\n              AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466\r\n            };\r\n            \r\n            $(''#shipping-new input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''#shipping-new input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''#shipping-new input[name="address_2"]'').val(data.bairro);\r\n                    $(''#shipping-new input[name="city"]'').val(data.cidade);\r\n                    $(''#shipping-new select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''#shipping-new select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                  \r\n                  $(''#shipping-new #input-payment-custom-field1'').focus();\r\n                })\r\n              }\r\n            })\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Altera a posição input -->\r\n  <file path="catalog/view/theme/*/template/account/register.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            $(''input[name="postcode"]'').mask(''99999-999'');\r\n            $(''input[name="telephone"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="fax"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="custom_field[account][4]"]'').mask(''999.999.999-99'');\r\n\r\n            $(''select[name="custom_field[account][3]"]'').change(function(){\r\n              if ($(''select[name="custom_field[account][3]"]'').val() == ''4'') {\r\n                $(''input[name="custom_field[account][4]"]'').mask(''99.999.999/9999-99'');\r\n              } else {\r\n       $(''input[name="custom_field[account][4]"]'').mask(''999.999.999-99'');\r\n       }\r\n            })\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Máscara cep -->\r\n  <file path="catalog/view/theme/*/template/checkout/cart.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            $(''input[name="postcode"]'').mask(''99999-999'');\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Account/edit -->\r\n  <file path="catalog/view/theme/*/template/account/address_form.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            $(''input[name="postcode"]'').mask(''99999-999'');\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Account/edit -->\r\n  <file path="catalog/view/theme/*/template/account/edit.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            $(''input[name="postcode"]'').mask(''99999-999'');\r\n            $(''input[name="telephone"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="fax"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="custom_field[4]"]'').mask(''999.999.999-99'');\r\n\r\n            $(''select[name="custom_field[account][3]"]'').change(function(){\r\n              if ($(''select[name="custom_field[account][3]"]'').val() == ''4'') {\r\n                $(''input[name="custom_field[account][4]"]'').mask(''99.999.999/9999-99'');\r\n              } else {\r\n        $(''input[name="custom_field[account][4]"]'').mask(''999.999.999-99'');\r\n       }\r\n            })\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <!-- Autocompletar endereço -->\r\n  <file path="catalog/view/theme/*/template/account/register.tpl,catalog/view/theme/*/template/account/address_form.tpl">\r\n    <operation>\r\n      <search><![CDATA[<?php echo $footer; ?>]]></search>\r\n      <add position="before"><![CDATA[\r\n          <script type="text/javascript">\r\n            var zones = {AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466\r\n            };\r\n            \r\n            $(''input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''input[name="address_2"]'').val(data.bairro);\r\n                    $(''input[name="city"]'').val(data.cidade);\r\n                    $(''select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                  \r\n                   $(''input[name="custom_field[address][5]"]'').focus();\r\n                })\r\n              }\r\n            })\r\n          </script>\r\n        ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n\r\n  <!--###########################-->\r\n  <!--           ADMIN           -->\r\n  <!--###########################-->\r\n  <file path="admin/controller/sale/order.php">\r\n    <operation>\r\n      <search><![CDATA[public function getForm() {]]></search>\r\n      <add position="after"><![CDATA[$this->document->addScript(''view/javascript/jquery/jquery.maskedinput.js'');]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <file path="admin/view/template/sale/order_form.tpl">\r\n    <operation>\r\n      <search index="1"><![CDATA[$(''.datetime'').datetimepicker({]]></search>\r\n      <add position="before"><![CDATA[\r\n        $(''input[name="postcode"]'').mask(''99999-999'');\r\n            $(''input[name="telephone"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="fax"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="custom_field[4]"]'').mask(''999.999.999-99'');\r\n\r\n            $(''select[name="custom_field[account][3]"]'').change(function(){\r\n              if ($(''select[name="custom_field[account][3]"]'').val() == ''4'') {\r\n                $(''input[name="custom_field[4]"]'').mask(''99.999.999/9999-99'');\r\n              }\r\n            })\r\n\r\n            var zones = {AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466};\r\n            \r\n            $(''#tab-payment input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''<?php echo HTTPS_CATALOG ?>index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''#tab-payment input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''#tab-payment input[name="address_2"]'').val(data.bairro);\r\n                    $(''#tab-payment input[name="city"]'').val(data.cidade);\r\n                    $(''#tab-payment select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''#tab-payment select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                   $(''input[name="custom_field[address][5]"]'').focus();\r\n                })\r\n              }\r\n            })\r\n            \r\n            $(''#tab-shipping input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''<?php echo HTTPS_CATALOG ?>index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''#tab-shipping input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''#tab-shipping input[name="address_2"]'').val(data.bairro);\r\n                    $(''#tab-shipping input[name="city"]'').val(data.cidade);\r\n                    $(''#tab-shipping select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''#tab-shipping select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                  $(''#input-shipping-custom-field1'').focus();\r\n                })\r\n              }\r\n            })\r\n\r\n            var inputPostcode = $(''#tab-shipping input[name="postcode"]'').parent().parent().detach();\r\n            $(''#tab-shipping input[name="address_1"]'').parent().parent().before(inputPostcode);\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <file path="catalog/controller/api/customer.php">\r\n    <operation>\r\n      <search><![CDATA[$this->response->addHeader(''Content-Type: application/json'');]]></search>\r\n      <add position="before"><![CDATA[\r\n        if (!$this->valida_cpf_cnpj()) {\r\n            $json[''error''][''custom_field4''] = ''CPF/CNPJ Incorreto.'';\r\n          }\r\n      ]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search><![CDATA[public function index() {]]></search>\r\n      <add position="before"><![CDATA[\r\n        private function valida_cpf_cnpj() {\r\n          $input = preg_replace(''/[^0-9]/'', '''', $this->request->post[''custom_field''][4]);\r\n\r\n          if (strlen($input) == 11) {\r\n            // Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            if (strlen($c) != 11 || preg_match("/^{$c[0]}{11}$/", $c)) {\r\n                return false;\r\n            }\r\n            for ($s = 10, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[9] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($s = 11, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[10] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n\r\n            return true;\r\n          } elseif (strlen($input) == 14) {\r\n\r\n            //Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            $b = array(6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2);\r\n            if (strlen($c) != 14) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i < 12; $n += $c[$i] * $b[++$i]);\r\n            if ($c[12] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i <= 12; $n += $c[$i] * $b[$i++]);\r\n            if ($c[13] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            return true;\r\n          }\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <file path="admin/controller/sale/customer.php">\r\n    <operation>\r\n      <search><![CDATA[protected function getForm() {]]></search>\r\n      <add position="after"><![CDATA[$this->document->addScript(''view/javascript/jquery/jquery.maskedinput.js'');]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search><![CDATA[if (isset($this->error[''address''])) {]]></search>\r\n      <add position="before"><![CDATA[\r\n        if (isset($this->error[''custom_field''])) {\r\n        $data[''error_custom_field''] = $this->error[''custom_field''];\r\n      } else {\r\n        $data[''error_custom_field''] = array();\r\n      }\r\n      ]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search index="0"><![CDATA[return !$this->error;]]></search>\r\n      <add position="before"><![CDATA[\r\n        if (!$this->valida_cpf_cnpj()) {\r\n            $this->error[''custom_field''][4] = ''CPF/CNPJ Incorreto.'';\r\n          }\r\n      ]]></add>\r\n    </operation>\r\n    <operation>\r\n      <search><![CDATA[protected function validateForm() {]]></search>\r\n      <add position="before"><![CDATA[\r\n        private function valida_cpf_cnpj() {\r\n          $input = preg_replace(''/[^0-9]/'', '''', $this->request->post[''custom_field''][4]);\r\n\r\n          if (strlen($input) == 11) {\r\n            // Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            if (strlen($c) != 11 || preg_match("/^{$c[0]}{11}$/", $c)) {\r\n                return false;\r\n            }\r\n            for ($s = 10, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[9] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($s = 11, $n = 0, $i = 0; $s >= 2; $n += $c[$i++] * $s--);\r\n            if ($c[10] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n\r\n            return true;\r\n          } elseif (strlen($input) == 14) {\r\n\r\n            //Code ported from jsfromhell.com\r\n            $c = preg_replace(''/\\D/'', '''', $input);\r\n            $b = array(6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2);\r\n            if (strlen($c) != 14) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i < 12; $n += $c[$i] * $b[++$i]);\r\n            if ($c[12] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            for ($i = 0, $n = 0; $i <= 12; $n += $c[$i] * $b[$i++]);\r\n            if ($c[13] != ((($n %= 11) < 2) ? 0 : 11 - $n)) {\r\n                return false;\r\n            }\r\n            return true;\r\n          }\r\n        }\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n\r\n  <file path="admin/view/template/sale/customer_form.tpl">\r\n    <operation>\r\n      <search index="1"><![CDATA[$(''.datetime'').datetimepicker({]]></search>\r\n      <add position="before"><![CDATA[\r\n        $(''input[name="postcode"]'').mask(''99999-999'');\r\n            $(''input[name="telephone"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="fax"]'').mask(''(99) 9999-9999?9'');\r\n            $(''input[name="custom_field[4]"]'').mask(''999.999.999-99'');\r\n\r\n            $(''select[name="custom_field[account][3]"]'').change(function(){\r\n              if ($(''select[name="custom_field[account][3]"]'').val() == ''4'') {\r\n                $(''input[name="custom_field[4]"]'').mask(''99.999.999/9999-99'');\r\n              }\r\n            })\r\n\r\n            var zones = {AC: 440,AL: 441,AP: 442,AM: 443,BA: 444,CE: 445,DF: 446,ES: 447,GO: 448,MA: 449,MT: 450,MS: 451,MG: 452,PA: 453,PB: 454,PR: 455,PE: 456,PI: 457,RJ: 458,RN: 459,RS: 460,RO: 461,RR: 462,SC: 463,SP: 464,SE: 465,TO: 466};\r\n            \r\n            $(''#tab-address input[name="postcode"]'').keyup(function(){\r\n              var text = $(this).val().toString();\r\n              if (text.replace(/[^0-9]/g, '''').length == 8){\r\n                var url = ''<?php echo HTTPS_CATALOG ?>index.php?route=valdeir/autocep&cep='' + text;\r\n                jQuery.getJSON(url, function(data){\r\n                  if (data.resultado == 1) {\r\n                    $(''#tab-address input[name="address_1"]'').val(data.tipo_logradouro + '' '' + data.logradouro);\r\n                    $(''#tab-address input[name="address_2"]'').val(data.bairro);\r\n                    $(''#tab-address input[name="city"]'').val(data.cidade);\r\n                    $(''#tab-address select[name="country_id"] option[value="30"]'').prop(''selected'',true);\r\n                    $(''#tab-address select[name="zone_id"] option[value="'' + zones[data.uf] + ''"]'').prop(''selected'',true);\r\n                  }\r\n                   $(''input[name="custom_field[address][5]"]'').focus();\r\n                })\r\n              }\r\n            })\r\n\r\n            var inputPostcode = $(''#tab-address input[name="postcode"]'').parent().parent().detach();\r\n            $(''#tab-address input[name="address_1"]'').parent().parent().before(inputPostcode);\r\n      ]]></add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-29 14:02:19'),
(7, 'Google Chrome Extension', 'valdeir_chrome_extension', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>Google Chrome Extension</name>\r\n  <version>1.0</version>\r\n  <author>Valdeir Psr</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  <code>valdeir_chrome_extension</code>\r\n  <file path="system/library/pagination.php">\r\n <operation>\r\n      <search><![CDATA[$output .= ''<li><a href="'' . str_replace(''{page}'', 1, $this->url) . ''">'' . $this->text_first . ''</a></li>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li data-page="1"><a href="'' . str_replace(''{page}'', 1, $this->url) . ''">'' . $this->text_first . ''</a></li>'';\r\n      ]]></add>\r\n    </operation>\r\n  \r\n  <operation>\r\n      <search><![CDATA[$output .= ''<li><a href="'' . str_replace(''{page}'', $page - 1, $this->url) . ''">'' . $this->text_prev . ''</a></li>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li data-page="'' . ($page-1) . ''"><a href="'' . str_replace(''{page}'', $page - 1, $this->url) . ''">'' . $this->text_prev . ''</a></li>'';\r\n   ]]></add>\r\n    </operation>\r\n \r\n  <operation>\r\n      <search><![CDATA[$output .= ''<li class="active"><span>'' . $i . ''</span></li>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li data-page="'' . $i . ''" class="active"><span>'' . $i . ''</span></li>'';\r\n    ]]></add>\r\n    </operation>\r\n \r\n  <operation>\r\n      <search><![CDATA[$output .= ''<li><a href="'' . str_replace(''{page}'', $i, $this->url) . ''">'' . $i . ''</a></li>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li><a data-page="'' . $i . ''" href="'' . str_replace(''{page}'', $i, $this->url) . ''">'' . $i . ''</a></li>'';\r\n    ]]></add>\r\n    </operation>\r\n \r\n  <operation>\r\n      <search><![CDATA[$output .= ''<li><a href="'' . str_replace(''{page}'', $page + 1, $this->url) . ''">'' . $this->text_next . ''</a>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li data-page="'' . ($page+1) . ''"><a href="'' . str_replace(''{page}'', $page + 1, $this->url) . ''">'' . $this->text_next . ''</a>'';\r\n   ]]></add>\r\n    </operation>\r\n \r\n  <operation>\r\n      <search><![CDATA[$output .= ''<li><a href="'' . str_replace(''{page}'', $num_pages, $this->url) . ''">'' . $this->text_last . ''</a>'';]]></search>\r\n      <add position="replace"><![CDATA[\r\n        $output .= ''<li data-page="'' . $num_pages . ''"><a href="'' . str_replace(''{page}'', $num_pages, $this->url) . ''">'' . $this->text_last . ''</a>'';\r\n    ]]></add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-28 23:29:44'),
(8, 'URL Amigáveis', 'valdeir_url_friendly', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>URL Amigáveis</name>\r\n  <code>valdeir_url_friendly</code>\r\n  <version>1.0</version>\r\n  <author>Valdeir S</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  <file path="admin/view/template/catalog/product_form.tpl,admin/view/template/catalog/information_form.tpl,admin/view/template/catalog/category_form.tpl">\r\n	<operation>\r\n      <search>\r\n        <![CDATA[<?php echo $footer; ?>]]>\r\n      </search>\r\n      <add position="before">\r\n        <![CDATA[<script>\r\n			$(''input[name="product_description[1][meta_title]"], input[name="category_description[1][meta_title]"], input[name="information_description[1][meta_title]"]'').blur(function(){\r\n				var meta_title = $(this).val();\r\n				\r\n				if (meta_title.length == 0){\r\n					return false;\r\n				}\r\n				\r\n				meta_title = $.trim(meta_title);\r\n				meta_title = meta_title.toLowerCase();\r\n				\r\n				var mapaAcentosHex 	= {\r\n					a: /[ÁÀÂÃÄÅáàâãä]/g,\r\n					e: /[ÉÊËéêë]/g,\r\n					i: /[ÍÎÏíîï]/g,\r\n					o: /[ÓÔÕÖØóôõöø]/g,\r\n					u: /[ÚÜúü]/g,\r\n					c: /[Çç]/g,\r\n					n: /[Ñ]/g,\r\n					d: /[Ð]/g,\r\n					x: /[×]/g,\r\n					y: /[Ýý]/g,\r\n					ae: /[æ]/g,\r\n					beta: /[ß]/g,\r\n					''-'': /\\s/g\r\n				};\r\n			 \r\n				for (var letra in mapaAcentosHex ) {\r\n					var expressaoRegular = mapaAcentosHex[letra];\r\n					meta_title = meta_title.replace(expressaoRegular, letra);\r\n				}\r\n				\r\n				meta_title = meta_title.replace(/-{2,}/g, ''-'');\r\n				\r\n				$(''input[name="keyword"'').val(meta_title);\r\n			});\r\n		</script>]]>\r\n      </add>\r\n    </operation>\r\n  </file>\r\n</modification>', 0, '2015-04-30 18:55:39'),
(9, 'Frete grátis por produto', 'valdeir_shipping_free_by_product', 'Valdeir Santana', '1.0', 'http://www.valdeirsantana.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>Shipping Free By Product</name>\r\n  <code>valdeir_shipping_free_by_product</code>\r\n  <version>1.0</version>\r\n  <author>Valdeir Santana</author>\r\n  <link>http://www.valdeirsantana.com.br</link>\r\n  <file path="admin/view/template/catalog/product_form.tpl">\r\n	<operation>\r\n      <search>\r\n        <![CDATA[<label class="col-sm-2 control-label"><?php echo $entry_shipping; ?></label>]]>\r\n      </search>\r\n      <add position="before" offset="1">\r\n        <![CDATA[\r\n		  <div class="form-group">\r\n			<label class="col-sm-2 control-label">Frete Grátis</label>\r\n			<div class="col-sm-10">\r\n			  <label class="radio-inline">\r\n				<?php if ($free_shipping) { ?>\r\n				<input type="radio" name="free_shipping" value="1" checked="checked" />\r\n				<?php echo $text_yes; ?>\r\n				<?php } else { ?>\r\n				<input type="radio" name="free_shipping" value="1" />\r\n				<?php echo $text_yes; ?>\r\n				<?php } ?>\r\n			  </label>\r\n			  <label class="radio-inline">\r\n				<?php if (!$free_shipping) { ?>\r\n				<input type="radio" name="free_shipping" value="0" checked="checked" />\r\n				<?php echo $text_no; ?>\r\n				<?php } else { ?>\r\n				<input type="radio" name="free_shipping" value="0" />\r\n				<?php echo $text_no; ?>\r\n				<?php } ?>\r\n			  </label>\r\n			</div>\r\n		  </div>\r\n		]]>\r\n      </add>\r\n    </operation>\r\n  </file>\r\n  \r\n  <file path="admin/controller/catalog/product.php">\r\n	<operation>\r\n	  <search><![CDATA[if (isset($this->request->post[''shipping''])) {]]></search>\r\n	  <add position="before"><![CDATA[\r\n		if (isset($this->request->post[''free_shipping''])) {\r\n			$data[''free_shipping''] = $this->request->post[''free_shipping''];\r\n		} elseif (!empty($product_info)) {\r\n			$data[''free_shipping''] = $product_info[''free_shipping''];\r\n		} else {\r\n			$data[''free_shipping''] = 0;\r\n		}\r\n	  ]]></add>\r\n	</operation>\r\n  </file>\r\n\r\n  <file path="admin/model/catalog/product.php">\r\n    <operation>\r\n	  <search><![CDATA[$product_id = $this->db->getLastId();]]></search>\r\n	  <add position="after"><![CDATA[$this->db->query(''UPDATE '' . DB_PREFIX . ''product SET free_shipping = "'' . $this->db->escape($data[''free_shipping'']) . ''" WHERE product_id = "'' . $product_id . ''"'');]]></add>\r\n	</operation>\r\n    <operation>\r\n	  <search><![CDATA[$this->event->trigger(''pre.admin.product.edit'', $data);]]></search>\r\n	  <add position="after"><![CDATA[$this->db->query(''UPDATE '' . DB_PREFIX . ''product SET free_shipping = "'' . $this->db->escape($data[''free_shipping'']) . ''" WHERE product_id = "'' . $product_id . ''"'');]]></add>\r\n	</operation>\r\n  </file>\r\n\r\n  <file path="catalog/model/shipping/correios.php">\r\n    <operation>\r\n	  <search><![CDATA[$produtos = $this->cart->getProducts();]]></search>\r\n	  <add position="replace"><![CDATA[\r\n	  $produtos = array();\r\n	  foreach($this->cart->getProducts() as $product) {\r\n		if (!$product[''free_shipping'']) {\r\n		  $produtos[] = $product;\r\n		}\r\n	  }\r\n	  ]]></add>\r\n	</operation>\r\n  </file>\r\n\r\n  <file path="system/library/cart.php">\r\n    <operation>\r\n	  <search><![CDATA[''shipping''        => $product_query->row[''shipping''],]]></search>\r\n	  <add position="after"><![CDATA[''free_shipping''        => $product_query->row[''free_shipping''],]]></add>\r\n	</operation>\r\n    <operation>\r\n	  <search index="0"><![CDATA[if ($product[''shipping'']) {]]></search>\r\n	  <add position="replace"><![CDATA[if ($product[''free_shipping'']) {]]></add>\r\n	</operation>\r\n  </file>\r\n\r\n  <file path="catalog/model/shipping/free.php">\r\n    <operation>\r\n	  <search><![CDATA[if (!$this->config->get(''free_geo_zone_id'')) {]]></search>\r\n	  <add position="before"><![CDATA[\r\n		$products = $this->cart->getProducts();\r\n		\r\n		foreach($products as $product){\r\n			if (!$product[''free_shipping'']){\r\n				$status = false;\r\n				break;\r\n			}\r\n		}\r\n	  ]]></add>\r\n	</operation>\r\n  </file>\r\n</modification>', 0, '2015-04-30 20:47:13'),
(10, 'OCMod Editor', 'ocmod-editor', 'Manoel Vidal', '1.1', 'http://www.opencartbrasil.com.br', '<?xml version="1.0" encoding="utf-8"?>\r\n<modification>\r\n  <name>OCMod Editor</name>\r\n  <code>ocmod-editor</code>\r\n  <version>1.1</version>\r\n  <author>Manoel Vidal</author>\r\n  <link>http://www.opencartbrasil.com.br</link>\r\n  <file path="admin/controller/extension/modification.php">\r\n    <operation>\r\n      <search>\r\n	    <![CDATA[$data[''modifications''][] = array(]]>\r\n      </search>\r\n      <add position="after">\r\n        <![CDATA[\r\n				''edit''            => $this->url->link(''extension/modification_editor'', ''token='' . $this->session->data[''token''] . ''&modification_id='' . $result[''modification_id''], ''SSL''),\r\n				''download''        => $this->url->link(''extension/modification_editor/download'', ''token='' . $this->session->data[''token''] . ''&modification_id='' . $result[''modification_id''], ''SSL''),\r\n		]]>\r\n      </add>\r\n    </operation>\r\n    <operation>\r\n      <search>\r\n	    <![CDATA[$data[''tab_log''] = $this->language->get(''tab_log'');]]>\r\n      </search>\r\n      <add position="after">\r\n        <![CDATA[\r\n		$this->load->language(''extension/modification_editor'');\r\n		$data[''button_edit''] = $this->language->get(''button_edit'');\r\n		$data[''button_download''] = $this->language->get(''button_download'');\r\n		]]>\r\n      </add>\r\n    </operation>\r\n  </file>\r\n\r\n  <file path="admin/view/template/extension/modification.tpl">\r\n    <operation>\r\n      <search>\r\n	    <![CDATA[<?php if (!$modification[''enabled'']) { ?>]]>\r\n      </search>\r\n      <add position="before">\r\n        <![CDATA[\r\n                        <a href="<?php echo $modification[''edit'']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>\r\n						<a href="<?php echo $modification[''download'']; ?>" data-toggle="tooltip" title="<?php echo $button_download; ?>" class="btn btn-success"><i class="fa fa-cloud-download"></i></a>\r\n		]]>\r\n      </add>\r\n    </operation>\r\n  </file>\r\n</modification>\r\n', 0, '2015-05-06 17:29:33');
...
(2, 'date', '', 'account', 1, 4),
(3, 'select', '', 'account', 1, 5),
(4, 'text', '', 'account', 1, 6),
(5, 'text', '', 'address', 1, 4),
(6, 'select', '', 'address', 1, 5);
...
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
(337, 0, 'update_pack_date', 'update_pack_date_last', '2015-05-01T00:00:00+02:00', 0),
(331, 0, 'update_pack', 'update_pack_last', 'a:0:{}', 1);