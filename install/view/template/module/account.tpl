			...
			<form action="index.php?route=step_6/configure&next=true" method="post" enctype="multipart/form-data" id="form">
				<table id="module" class="list">
					...
					<tbody id="module-row0">
						<tr>
							<td class="left">
								<select name="account_module[0][layout_id]">
							...
							<td class="left">
								<select name="account_module[0][position]">
									<option value="content_top">Topo do Conteúdo</option>
									<option value="content_bottom">Rodapé do Conteúdo</option>
									<option value="column_left">Coluna Esquerda</option>
									<option value="column_right" selected="selected">Coluna Direita</option>
								</select>
							</td>
							<td class="left">
								<select name="account_module[0][status]">
...
<script type="text/javascript"><!--
	...
	function addModule() {	
		...
		html += '      <option value="column_left">Coluna Esquerda</option>';
		html += '      <option value="column_right">Coluna Direita</option>';
		html += '    </select></td>';
