			...
			<form action="index.php?route=step_6/configure&next=true" method="post" enctype="multipart/form-data" id="form">
				<table id="module" class="list">
					...
					<tbody id="module-row0">
						<tr>
							<td class="left"><input type="text" name="bestseller_module[0][limit]" value="5" size="1" /></td>
							<td class="left"><input type="text" name="bestseller_module[0][image_width]" value="80" size="3" /> <input type="text" name="bestseller_module[0][image_height]" value="80" size="3" /></td>
							<td class="left">
								<select name="bestseller_module[0][layout_id]">
							...
							<td class="left">
								<select name="bestseller_module[0][position]">
							...
							<td class="left">
								<select name="bestseller_module[0][status]">
									<option value="1" selected="selected">Habilitado</option>
									<option value="0">Desabilitado</option>
								</select>
							</td>
							<td class="right"><input type="text" name="bestseller_module[0][sort_order]" value="" size="3" /></td>
