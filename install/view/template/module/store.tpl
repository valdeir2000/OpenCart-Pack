		...
		<div class="content">
			<form action="index.php?route=step_6/configure&next=true" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					<tbody>
						<tr>
							<td>Acesso somente para administradores:</td>
							<td>
								<input type="radio" name="store_admin" value="1" />Sim
								<input type="radio" name="store_admin" value="0" checked="checked" />Não              
							</td>
						</tr>
					</tbody>
				</table>
