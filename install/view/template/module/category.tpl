			...
			<form action="index.php?route=step_6/configure&next=true" method="post" enctype="multipart/form-data" id="form">
				<table id="module" class="list">
					...
					<tbody id="module-row0">
						<tr>
							<td class="left">
								<select name="category_module[0][layout_id]">
									<option value="6">Account</option>
									<option value="10">Affiliate</option>
									<option value="3" selected="selected">Category</option>
							...
							<td class="left">
								<select name="category_module[0][position]">
									<option value="content_top">Topo do Conteúdo</option>
									<option value="content_bottom">Rodapé do Conteúdo</option>
									<option value="column_left" selected="selected">Coluna da Esquerda</option>
									<option value="column_right">Coluna da Direita</option>
								</select>
							</td>
							<td class="left">
								<select name="category_module[0][status]">
									<option value="1" selected="selected">Habilitado</option>
									<option value="0">Desabilitado</option>
								</select>
							</td>
							<td class="right"><input type="text" name="category_module[0][sort_order]" value="1" size="3" /></td>
							<td class="left"><a onclick="$('#module-row0').remove();" class="button">Remover</a></td>
						</tr>
					</tbody>
					<tbody id="module-row1">
						<tr>
							<td class="left">
								<select name="category_module[1][layout_id]">
									<option value="6">Account</option>
									<option value="10">Affiliate</option>
									...
									<option value="11">Information</option>
									<option value="5">Manufacturer</option>
									<option value="2" selected="selected">Product</option>
									<option value="9">Sitemap</option>
								</select>
							</td>
							<td class="left">
								<select name="category_module[1][position]">
									<option value="content_top">Topo do Conteúdo</option>
									<option value="content_bottom">Rodapé do Conteúdo</option>
									<option value="column_left" selected="selected">Coluna da Esquerda</option>
									<option value="column_right">Coluna da Direita</option>
							...
							<td class="left">
								<select name="category_module[1][status]">
									<option value="1" selected="selected">Habilitado</option>
									<option value="0">Desabilitado</option>
								</select>
							</td>
							<td class="right"><input type="text" name="category_module[1][sort_order]" value="1" size="3" /></td>
							<td class="left"><a onclick="$('#module-row1').remove();" class="button">Remover</a></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
