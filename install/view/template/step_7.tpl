...
<div class="container">
  <header class="div row">
    <div class="col-sm-6">
      <h1 class="pull-left">7<small>/11</small></h1>
      <h3><?php echo $heading_step_7 ?><small><?php echo $heading_step_7_small ?></small>
    </div>
    <div class="col-sm-6">
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
      <ul class="list-group">
        ...
        <li class="list-group-item"><b><?php echo $text_order_total; ?></b></li>
