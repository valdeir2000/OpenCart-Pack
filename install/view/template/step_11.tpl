...
<div class="container">
  ...
  <div class="col-sm-12">
    <div class="col-sm-6">
      <h1>Suporte</h1>
      <p>Valdeir S. | valdeir.naval@gmail.com | <a href="http://www.valdeirsantana.com.br/#contacts" target="_BLANK">http://www.valdeirsantana.com.br/</a></p>
    </div>

    <div class="col-sm-6">
      <h1>Módulos Utilizados no Pack</h1>
      <p><a href="http://www.valdeirsantana.com.br/index.php?route=opencart/extension/listModules&utm_source=opencart_pack&utm_medium=opencart_pack&utm_campaign=opencart_pack" target="_BLANK">Lista de Módulos</a></p>
    </div>

    <div class="col-sm-6">
      <h1>Tradução</h1>
      <p><a href="https://github.com/opencartbrasil/traducao" target="_BLANK">https://github.com/opencartbrasil/traducao</a></p>
    </div>

    <div class="col-sm-6">
      <h1>Contribua conosco</h1>
      <p>
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=HUBL785QDAXXG" target="_BLANK">
          <img src="https://www.paypalobjects.com/pt_BR/BR/i/btn/btn_donateCC_LG.gif" alt="">
        </a>
      </p>
    </div>
  </div>
  ...
  <div class="language" id="module-language" style="display:none;"></div>
    <div class="modules">
      ...
      <div class="row">
        <div class="col-sm-12 text-center"> <a class="btn btn-default" href="http://www.opencart.com/index.php?route=extension/extension&filter_username=valdeir2000" target="_BLANK"><?php echo $text_store; ?></a> </div>
      </div>
    </div>
  ...
  <div class="core-modules">
    <div class="row">
      <div class="col-sm-6 text-center"> <img src="view/image/openbay_pro.gif">
        <p><?php echo $text_openbay; ?> <a href="http://www.openbaypro.com/?utm_source=valdeirsantana.com.br&utm_medium=referral&utm_campaign=opencart_install"><?php echo $text_more_info; ?></a></p>
      ...
      <div class="col-sm-6 text-center"> <img src="view/image/maxmind.gif">
        <p><?php echo $text_maxmind; ?> <a href="http://www.maxmind.com/?utm_source=valdeirsantana.com.br&utm_medium=referral&utm_campaign=opencart_install"><?php echo $text_more_info; ?></a></p>
  ...
  <div class="support text-center">
    <div class="row">
      ...
      <div class="col-sm-4"> <a href="http://forum.opencart.com/?utm_source=valdeirsantana.com.br&utm_medium=forum_link&utm_campaign=opencart_install" class="icon transition"> <i class="fa fa-comments fa-4x"></i> </a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_info; ?></p>
        <a href="http://forum.opencart.com/?utm_source=valdeirsantana.com.br&utm_medium=forum_link&utm_campaign=opencart_install"><?php echo $text_forum_link; ?></a> </div>
      <div class="col-sm-4">
        <a href="http://www.valdeirsantana.com.br/#contacts" class="icon transition"> <i class="fa fa-user fa-4x"></i> </a>
         <h3><?php echo $text_commercial; ?></h3>
         <p><?php echo $text_commercial_info; ?></p>
         <a href="http://www.valdeirsantana.com.br/#contacts" target="_BLANK"><?php echo $text_commercial_link; ?></a> </div>
      </div>
    </div>
  </div>
<?php echo $footer; ?> 
...
function searchExtensions() {
  ...
  $.ajax({
    url: 'index.php?route=step_11/extensions',
    type: 'post',
    dataType: 'json',
    beforeSend: function() {
...
function searchLanguages() {
  ...
  $.ajax({
    url: 'index.php?route=step_11/language',
    type: 'post',
      ...
      if (json.extension != '') {
        html = '<div class="row">';
          html += '<div class="col-sm-12">';
            ...
            html += '<a class="btn btn-primary" href="'+json.extension.href.replace('utm_source=opencart_install', 'utm_source=valdeirsantana.com.br') +'" target="_BLANK"><?php echo $text_download; ?></a>';
          html += '</div>';
        html += '</div>';
