							...
							<tr>
								<td>
									...
									<table cellspacing="0" height="50px" width="100%">
										<tr>
											<td style="background:#F00;color:#FFF;padding:0px 30px;text-align:center;width:30%;float:left;top:-15px;position:relative">
							...
							<tr>
								<td>
									...
									<table style="width:100%;" cellspacing="0">
										<tr>
											<td style="width:33%;float:left;color:#727272;padding-left:30px">
												<h3 style="margin:0px;padding:0;">From:</h3><br/>
												<span><?php echo $store_name ?></span><br/>
												<?php echo $store_address ?>
											</td>
											
											<td style="width:33%;float:left;color:#727272;">
